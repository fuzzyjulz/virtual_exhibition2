VirtualExhibition::Application.configure do
  ...
  ###################
  # Internal Settings
  config.virtual_conferences.admin_email = "devops@commstrat.com.au"
  ...
  config.action_mailer.default_url_options = { :host => 'http://virtualcareersfair.com.au' }
  config.action_mailer.delivery_method = :smtp
  config.action_mailer.smtp_settings = {
    :address              => "smtp.mandrillapp.com", 
    :port                 => 587,
    :domain               => 'commstrat.com.au',
    :user_name            => "jae.choi@commstrat.com.au",
    :password             => "JSrQ5AbHVCkopCrvtBNXfw",
    }
  ...
  config.disqus.shortname = "virtual-conferences-prod"
