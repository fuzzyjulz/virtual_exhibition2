VirtualExhibition::Application.configure do
  ...
  config.action_mailer.default_url_options = { :host => 'http://vc-staging.herokuapp.com' }
  config.action_mailer.delivery_method = :smtp
  config.action_mailer.smtp_settings = {
    :address              => "smtp.mandrillapp.com", 
    :port                 => 587,
    :domain               => 'vc-staging.herokuapp.com',
  ...
  config.disqus.shortname = "virtual-conferences-staging"
